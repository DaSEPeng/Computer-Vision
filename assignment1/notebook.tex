...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} 使用验证集调整学习率和正则化强度}
        ...
        \PY{k}{for} \PY{n}{lr} \PY{o+ow}{in} \PY{n}{learning\PYZus{}rates}\PY{p}{:}
            \PY{k}{for} \PY{n}{reg} \PY{o+ow}{in} \PY{n}{regularization\PYZus{}strengths}\PY{p}{:}
                ...
                \PY{n}{loss\PYZus{}history} \PY{o}{=} \PY{n}{svm}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}feats}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{n}{lr}\PY{p}{,} \PY{n}{reg}\PY{o}{=}\PY{n}{reg}\PY{p}{,} \PY{n}{num\PYZus{}iters}\PY{o}{=}\PY{l+m+mi}{1500}\PY{p}{,}
                      \PY{n}{verbose}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}        
                
                \PY{n}{train\PYZus{}pred} \PY{o}{=} \PY{n}{svm}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}feats}\PY{p}{)}
                \PY{n}{train\PYZus{}acc} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{y\PYZus{}train} \PY{o}{==} \PY{n}{train\PYZus{}pred}\PY{p}{)}
                \PY{n}{val\PYZus{}pred} \PY{o}{=} \PY{n}{svm}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}val\PYZus{}feats}\PY{p}{)}
                \PY{n}{val\PYZus{}acc} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{y\PYZus{}val} \PY{o}{==} \PY{n}{val\PYZus{}pred}\PY{p}{)}
                
                \PY{n}{results}\PY{p}{[}\PY{p}{(}\PY{n}{lr}\PY{p}{,}\PY{n}{reg}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{train\PYZus{}acc}\PY{p}{,}\PY{n}{val\PYZus{}acc}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
lr 1.000000e-09 reg 5.000000e+04 train accuracy: 0.109959 val accuracy: 0.096000
lr 1.000000e-09 reg 5.000000e+05 train accuracy: 0.093143 val accuracy: 0.089000
lr 1.000000e-09 reg 5.000000e+06 train accuracy: 0.415163 val accuracy: 0.411000
lr 1.000000e-08 reg 5.000000e+04 train accuracy: 0.099673 val accuracy: 0.118000
lr 1.000000e-08 reg 5.000000e+05 train accuracy: 0.417082 val accuracy: 0.413000
lr 1.000000e-08 reg 5.000000e+06 train accuracy: 0.398510 val accuracy: 0.392000
lr 1.000000e-07 reg 5.000000e+04 train accuracy: 0.412163 val accuracy: 0.421000
lr 1.000000e-07 reg 5.000000e+05 train accuracy: 0.403265 val accuracy: 0.397000
lr 1.000000e-07 reg 5.000000e+06 train accuracy: 0.309571 val accuracy: 0.303000
...
\(\color{blue}{\textit 答:}\)
\textbf{虽然有些图片被分错类了，但是被分错还是有道理的。因为我们这里只提取了条纹和颜色的特征，如第一行第九张图片，蓝色的背景很像天空，而第八列的第三张和最后一张图片，在纹理特征上和马也可能比较像，如果分类器重点关注了条纹和颜色的特征，就容易将上述图片分类错误。其他一些图片类似，都隐约能在条纹或者颜色上找到和标签所说的事物相似的特征。}
...
(49000, 154)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k+kn}{from} \PY{n+nn}{daseCV}\PY{n+nn}{.}\PY{n+nn}{classifiers}\PY{n+nn}{.}\PY{n+nn}{neural\PYZus{}net} \PY{k}{import} \PY{n}{TwoLayerNet}
         ...
         \PY{n}{best\PYZus{}val} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}
         \PY{n}{results} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
         \PY{n}{stats} \PY{o}{=} \PY{k+kc}{None}
         
         \PY{n}{learning\PYZus{}rates} \PY{o}{=} \PY{p}{[}\PY{l+m+mf}{13e\PYZhy{}2}\PY{p}{,} \PY{l+m+mf}{13e\PYZhy{}1}\PY{p}{]} \PY{c+c1}{\PYZsh{} 可以通过损失函数下降图像来调整学习率}
         \PY{n}{regularization\PYZus{}strengths} \PY{o}{=} \PY{p}{[}\PY{l+m+mf}{7.5e\PYZhy{}6}\PY{p}{,} \PY{l+m+mf}{7.7e\PYZhy{}5}\PY{p}{]} 
         \PY{n}{learning\PYZus{}rate\PYZus{}decay} \PY{o}{=} \PY{p}{[}\PY{l+m+mf}{0.99}\PY{p}{]}   \PY{c+c1}{\PYZsh{} 试过0.95  0.90 效果不是太好 }
         
         \PY{k}{for} \PY{n}{lr} \PY{o+ow}{in} \PY{n}{learning\PYZus{}rates}\PY{p}{:}
             \PY{k}{for} \PY{n}{reg} \PY{o+ow}{in} \PY{n}{regularization\PYZus{}strengths}\PY{p}{:}
                 \PY{k}{for} \PY{n}{decay} \PY{o+ow}{in} \PY{n}{learning\PYZus{}rate\PYZus{}decay}\PY{p}{:}
                     \PY{n}{net} \PY{o}{=} \PY{n}{TwoLayerNet}\PY{p}{(}\PY{n}{input\PYZus{}dim}\PY{p}{,} \PY{n}{hidden\PYZus{}dim}\PY{p}{,} \PY{n}{num\PYZus{}classes}\PY{p}{)}
                     \PY{n}{tmp\PYZus{}stats} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}feats}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}val\PYZus{}feats}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{,}
                         \PY{n}{num\PYZus{}iters}\PY{o}{=}\PY{l+m+mi}{2000}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{200}\PY{p}{,}
                         \PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{n}{lr}\PY{p}{,} \PY{n}{learning\PYZus{}rate\PYZus{}decay}\PY{o}{=}\PY{n}{decay}\PY{p}{,}
                         \PY{n}{reg}\PY{o}{=}\PY{n}{reg}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
         
                     \PY{n}{pred\PYZus{}train} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}feats}\PY{p}{)}
                     \PY{n}{train\PYZus{}acc} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{pred\PYZus{}train} \PY{o}{==} \PY{n}{y\PYZus{}train}\PY{p}{)}
                     \PY{n}{pred\PYZus{}val} \PY{o}{=} \PY{n}{net}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}val\PYZus{}feats}\PY{p}{)}
                     \PY{n}{val\PYZus{}acc} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{pred\PYZus{}val} \PY{o}{==} \PY{n}{y\PYZus{}val}\PY{p}{)}
                     
                     \PY{n}{results}\PY{p}{[}\PY{p}{(}\PY{n}{lr}\PY{p}{,}\PY{n}{reg}\PY{p}{,}\PY{n}{decay}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{train\PYZus{}acc}\PY{p}{,}\PY{n}{val\PYZus{}acc}\PY{p}{)}
         
                     \PY{k}{if}\PY{p}{(}\PY{n}{val\PYZus{}acc} \PY{o}{\PYZgt{}} \PY{n}{best\PYZus{}val}\PY{p}{)}\PY{p}{:}
                         \PY{n}{best\PYZus{}val} \PY{o}{=} \PY{n}{val\PYZus{}acc}
                         \PY{n}{best\PYZus{}net} \PY{o}{=} \PY{n}{net}
                         \PY{n}{stats} \PY{o}{=} \PY{n}{tmp\PYZus{}stats}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Print out results.}
         \PY{k}{for} \PY{n}{lr}\PY{p}{,} \PY{n}{reg}\PY{p}{,} \PY{n}{decay} \PY{o+ow}{in} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{results}\PY{p}{)}\PY{p}{:}
             \PY{n}{train\PYZus{}accuracy}\PY{p}{,} \PY{n}{val\PYZus{}accuracy} \PY{o}{=} \PY{n}{results}\PY{p}{[}\PY{p}{(}\PY{n}{lr}\PY{p}{,} \PY{n}{reg}\PY{p}{,} \PY{n}{decay}\PY{p}{)}\PY{p}{]}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{lr }\PY{l+s+si}{\PYZpc{}e}\PY{l+s+s1}{ reg }\PY{l+s+si}{\PYZpc{}e}\PY{l+s+s1}{ decay }\PY{l+s+si}{\PYZpc{}e}\PY{l+s+s1}{ train accuracy: }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s1}{ val accuracy: }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{p}{(}
                         \PY{n}{lr}\PY{p}{,} \PY{n}{reg}\PY{p}{,} \PY{n}{decay}\PY{p}{,} \PY{n}{train\PYZus{}accuracy}\PY{p}{,} \PY{n}{val\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
lr 1.300000e-01 reg 7.500000e-06 decay 9.900000e-01 train accuracy: 0.596816 val accuracy: 0.569000
lr 1.300000e-01 reg 7.700000e-05 decay 9.900000e-01 train accuracy: 0.598143 val accuracy: 0.561000
lr 1.300000e+00 reg 7.500000e-06 decay 9.900000e-01 train accuracy: 0.727531 val accuracy: 0.550000
lr 1.300000e+00 reg 7.700000e-05 decay 9.900000e-01 train accuracy: 0.735388 val accuracy: 0.539000
best validation accuracy achieved during cross-validation: 0.569000

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} Plot the loss function and train / validation accuracies}
         \PY{c+c1}{\PYZsh{} 为了调试单独拿出来写了}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} 在测试集上运行得到的最好的神经网络分类器，应该能够获得55％以上的准确性。}
